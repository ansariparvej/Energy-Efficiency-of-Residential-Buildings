...
class DataIngestion:
    ...
    def __init__(self, data_ingestion_config: DataIngestionConfig):
        try:
            ...
            self._schema_config = read_yaml_file(SCHEMA_FILE_PATH)  # config/schema.yaml
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            dataframe = energy_data.export_collection_as_dataframe(collection_name=self.data_ingestion_config.collection_name)
