...
from energy_efficiency.entity.artifact_entity import DataValidationArtifact, ModelTrainerArtifact, ModelEvaluationArtifact
from energy_efficiency.entity.config_entity import ModelEvaluationConfig
import os
import sys
